...
my $RANDOM_NOCTURNE = Quant::Framework::TradingCalendar->new({symbol=>'RANDOM_NOCTURNE', chronicle_reader => $chronicle_r});
my $ASX             = Quant::Framework::TradingCalendar->new({symbol=>'ASX', chronicle_reader => $chronicle_r});
my $NYSE            = Quant::Framework::TradingCalendar->new({symbol=>'NYSE', chronicle_reader => $chronicle_r});
my $HKSE            = Quant::Framework::TradingCalendar->new({symbol=>'HKSE', chronicle_reader => $chronicle_r});
my $ISE             = Quant::Framework::TradingCalendar->new({symbol=>'ISE', chronicle_reader => $chronicle_r});
...
subtest 'trading_date_can_differ' => sub {
    ...
    my $never_differs = Quant::Framework::TradingCalendar->new({symbol=>'NYSE', chronicle_reader => $chronicle_r});
    ok(!$never_differs->trading_date_can_differ, $never_differs->symbol . ' never trades on a different day than the UTC calendar day.');
    my $always_differs = Quant::Framework::TradingCalendar->new({symbol=>'RANDOM_NOCTURNE', chronicle_reader => $chronicle_r});
    ...
    my $sometimes_differs = Quant::Framework::TradingCalendar->new({symbol=>'ASX', chronicle_reader => $chronicle_r});
...
subtest 'regular_trading_day_after' => sub {
    my $exchange = Quant::Framework::TradingCalendar->new({symbol=>'FOREX', chronicle_reader => $chronicle_r});
    lives_ok {
...
subtest 'trading period' => sub {
    my $ex           = Quant::Framework::TradingCalendar->new({symbol=>'HKSE', chronicle_reader => $chronicle_r});
    ...
    $ex = Quant::Framework::TradingCalendar->new({symbol=>'FOREX', chronicle_reader => $chronicle_r});
    lives_ok {
        my $p = $ex->trading_period($trading_date);
        # daily_open: 0s
...
subtest 'standard_closing_on early close' => sub {
    ...
    my $fx                   = Quant::Framework::TradingCalendar->new({symbol=>'FOREX', chronicle_reader => $chronicle_r});
